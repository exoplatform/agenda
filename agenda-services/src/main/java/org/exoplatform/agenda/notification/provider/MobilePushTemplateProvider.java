...
public class MobilePushTemplateProvider extends TemplateProvider {
  public MobilePushTemplateProvider(IdentityManager identityManager, ExoContainer container, InitParams initParams) {
    super(initParams);
    this.templateBuilders.put(EVENT_ADDED_KEY,
                              new AgendaTemplateBuilder(this, container, identityManager, EVENT_ADDED_KEY, true));
    this.templateBuilders.put(EVENT_MODIFIED_KEY,
                              new AgendaTemplateBuilder(this, container, identityManager, EVENT_MODIFIED_KEY, true));
  }
}
