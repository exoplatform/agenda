...
export default {
  ...
  methods: {
    ...
    retrieveEventsFromStore() {
      ...
      this.$eventService.getEvents(this.searchTerm, this.ownerIds, userIdentityId, this.$agendaUtils.toRFC3339(this.period.start, true), this.$agendaUtils.toRFC3339(this.period.end), this.limit, false)
        .then(data => {
