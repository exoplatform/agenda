...
export default {
  ...
  methods: {
    ...
    retrieveEventsFromStore() {
      ...
      const attendeeResponseStatuses = ['ALL'];
      this.$eventService.getEvents(this.searchTerm, this.ownerIds, userIdentityId, this.$agendaUtils.toRFC3339(this.period.start, true), this.$agendaUtils.toRFC3339(this.period.end), this.limit, attendeeResponseStatuses)
        .then(data => {
