...
export function getEvents(query, ownerIds, attendeeIdentityId, start, end, limit, attendeeResponseStatuses, expand) {
  ...
  if (attendeeResponseStatuses) {
    params.attendeeResponseStatuses = attendeeResponseStatuses;
  }
